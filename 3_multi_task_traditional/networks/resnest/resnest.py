...
import torch
from .resnet import ResNet, Bottleneck, ResNet_cla_seg
...
def resnest50_cla_seg(pretrained=True, root='~/.encoding/models', **kwargs):
    model = ResNet_cla_seg(Bottleneck, [3, 4, 6, 3],
                   radix=2, groups=1, bottleneck_width=64,
                   deep_stem=True, stem_width=32, avg_down=True,
                   avd=True, avd_first=False, **kwargs)
    if pretrained:
