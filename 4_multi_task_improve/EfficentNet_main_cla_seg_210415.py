...
from torch_struct.smg_w_cascade import cascade_net
...
train_data_root = '/media/root/Elements1/GP9/PNETs_anchor_data_70-150_classify_center1_plus15'
vaild_data_root = '/media/root/Elements1/GP9/PNETs_anchor_data_70-150_classify_center1_plus15'
test_data_root = '/media/root/Elements1/GP9/PNETs_anchor_data_70-150_classify_center2_plus15'
...
# args.save_dir = '/media/root/83705360-882b-4f01-9201-5ba77b3d189b/20201112_Chia_Code_for classify/GP7/LXY/pNENs_210226_cla_seg_aug/' + str(args.fold) + '/model' #（这个文件夹-多任务）
args.save_dir = '/media/root/Elements1/GP11/LXY/pNENs_210416_cla_seg_aug_70-150/' + str(args.fold) + '/model'
...
model = cascade_net(class_num=2, seg_num=1)
...
'''optimizer, lr'''
optimizer = torch.optim.AdamW(model.parameters(), lr=1e-3)#lr=1e-5
args.scheduler = lr_scheduler.OneCycleLR(optimizer, max_lr=1e-2, steps_per_epoch=len(train_loader), epochs=args.epochs) # 学习率使用onecycleLR,先上升后下降

W_path = '/media/root/Elements1/GP11/LXY/pNENs_210416_cla_seg_aug_70-150/' + str(args.fold) + '/run'
...
for epoch in range(0, args.epochs):
    ...
    save_path = '/media/root/Elements1/GP11/LXY/pNENs_210416_cla_seg_aug_70-150/' \
    ...
    save_path_seg = '/media/root/Elements1/GP11/LXY/pNENs_210416_cla_seg_aug_70-150/' \
    ...
    save_path2 = '/media/root/Elements1/GP11/LXY/pNENs_210416_cla_seg_aug_70-150/' \
    ...
    save_path2_seg = '/media/root/Elements1/GP11/LXY/pNENs_210416_cla_seg_aug_70-150/' \
