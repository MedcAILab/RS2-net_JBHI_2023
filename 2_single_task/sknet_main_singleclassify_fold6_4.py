...
# from networks.resnest.resnest import  resnest50
# from networks.ResNest_aT.resnest import resnest50
# from networks.densenet.Densenet import densenet
from networks.sknet.sknet import SKNet50

'''70-150-外扩15单任务深度学习分类'''
...
train_data_root = '/media/root/Elements/GP9/PNETs_anchor_data_70-150_classify_center1_plus15 (copy)'
vaild_data_root = '/media/root/Elements/GP9/PNETs_anchor_data_70-150_classify_center1_plus15 (copy)'
test_data_root = '/media/root/Elements/GP9/PNETs_anchor_data_70-150_classify_center2_plus15 (copy)'
...
args.save_dir = '/media/root/83705360-882b-4f01-9201-5ba77b3d189b/20201112_Chia_Code_for classify/GP/pNENs_210423_cla_sknet_70-150/' + str(args.fold) + '/model'
...
args.scheduler = lr_scheduler.OneCycleLR(optimizer, max_lr=1e-5, steps_per_epoch=len(train_loader), epochs=args.epochs)

W_path = '/media/root/83705360-882b-4f01-9201-5ba77b3d189b/20201112_Chia_Code_for classify/GP/pNENs_210423_cla_sknet_70-150/' + str(args.fold) + '/run'
...
for epoch in range(0, args.epochs):
    ...
    train_loss, cla_loss = train_step_cls(train_loader, model, epoch, optimizer, criterion, args)
    ...
    # validation_auc, validation_Loss, valid_ID, valid_label, valid_score, val_precision, val_recall, val_f1 = validation_step(vaild_data_root, args.fold, model, criterion)
    validation_auc, validation_Loss, valid_ID, valid_label, valid_score = validation_step_cla(vaild_data_root, args.fold, model, criterion)
    ...
    print('-----------------------------Testing stage-------------------------------------')
    # external_auc, external_Loss, external_ID, external_label, external_score, ex_precision, ex_recall, ex_f1 = externalData_step(test_data_root, args.fold, model, criterion)
    external_auc, external_Loss, external_ID, external_label, external_score = externalData_step_cla(test_data_root, args.fold, model, criterion)
    ...
    writer.add_scalars('1_train_loss_cla_seg', {'cla_loss': cla_loss #,'seg_loss': seg_loss
                                                }, epoch)
    ...
    save_path = '/media/root/83705360-882b-4f01-9201-5ba77b3d189b/20201112_Chia_Code_for classify/GP/pNENs_210423_cla_sknet_70-150/' \
    ...
    # save_path_seg = '/media/root/83705360-882b-4f01-9201-5ba77b3d189b/20201112_Chia_Code_for classify/GP/pNENs_201223_cla/' \
    ...
    save_path2 = '/media/root/83705360-882b-4f01-9201-5ba77b3d189b/20201112_Chia_Code_for classify/GP/pNENs_210423_cla_sknet_70-150/' \
    ...
    # save_path2_seg = '/media/root/83705360-882b-4f01-9201-5ba77b3d189b/20201112_Chia_Code_for classify/GP/pNENs_201223_cla/' \
